document.addEventListener("DOMContentLoaded", function () {
    ...
    addLocInput.addEventListener("input", () =>
    ...
    document
        ...
        .forEach((button) => {
            button.addEventListener("click", function () {
                ...
                const nomeProduto = productElement
                ...
                const saborAdicional = saborAdicionalInput
                    ? saborAdicionalInput.value
                    : "";
